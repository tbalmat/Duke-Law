...
shinyUI(
  fluidPage(
    ...
    HTML("<br><b>Duke University Law School - LexisNexis Appeal Outcome Text Analysis - Word Association Networks</b><br><br>"),

    # prompts
    fluidRow(width=12,
      column(width=4, radioButtons("caseType", "Case Type", choices=rep("", 5), selected="", inline=T)),
      column(width=5, radioButtons("outcomeType", "Outcome Type", choices=rep("", 4), selected="", inline=T))
