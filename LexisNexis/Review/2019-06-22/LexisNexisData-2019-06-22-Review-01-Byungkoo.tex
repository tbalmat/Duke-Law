...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \footnotesize{3XNJ-6V30-0038-X1MH-00000-00, Wilder v. United States, 182 F.3d 934, 1999-04-29}
        ...
        \begin{itemize}
            \item \footnotesize{Friedman v. United States (1988 U.S. App. LEXIS 22018, with panel; 1988 U.S. App. LEXIS 6749, no panel)}
        ...
        \item A random sample of 220 cases was examined for panel size. Many cases occurring with a panel of size other than three are reported on-line as having a three judge panel. Following are examples
            \item  Pattern1: Three Judge Panel Reported as One or Two Judge Panel
        \begin{itemize}
            \item  Judges without Hyperlinks are Not Included in the Panel
            \begin{itemize}
                \item \footnotesize{1975; 3S4X-3RD0-0039-M292-00000-00 Wolf v. Jane Phillips Episcopal-Memorial Medical Center \\
...
%                \item \emph{The list goes on. For the majority of these cases, it seems that missing judges do not have hyperlinks.}
                \item \emph{115 two judge panel cases were sampled, and 110 of them turned out to be three judge panel cases}
            \end{itemize}
        \end{itemize}
        
        \item Pattern2: Three Judge Panel Reported as Four or More Judge Panel
        \begin{itemize}            
            \item Judge of different court level included in the panel
            \begin{itemize} 
                \item \footnotesize{1987; 3S4X-BKC0-001B-K27G-00000-00 Richard A. Plehn, Inc. v. Gould \\
                (Hilton and Merhige, district court judges before appeal, included in panel in addition to the three judges)}
                
                \item 1988; 3S4W-YDM0-001B-K27K-00000-00 MARTIN v. UNITED STATES \\
                (Scalia, the Supreme court judge, is included in the panel. Scalia only appears in the opinion text)
            \end{itemize}
            
            \item One judge counted multiple times
            \begin{itemize} 
                \item \footnotesize{1989; 3S4X-C640-003B-555C-00000-00 Vaccaro v. Stephens \\
            ...
            \begin{itemize}                     
                \item \footnotesize{1985; 3S4X-JKR0-0039-P50D-00000-00 Weems v. Ball Metal \& Chemical Div., Inc. \\
                (Bailey Brown and Jones Brown both included in the panel. However, we see only the last name ``Brown"Äù in LN search result. The hyperlink of ``Brown" leads to Bailey Brown, suggesting that Jones Brown may be added by mistake)}
            \end{itemize}
        \end{itemize}
    ...
    \begin{itemize}
        \item \footnotesize{Case: 3S4X-64W0-001B-K0KB-00000-00; Bouchillon v. Collins, 907 F.2d 589\\
    ...
    \footnotesize{3S4X-BYM0-001B-K3HW-00000-00\\}
    ...
    \item \normalsize Judge names.  Twenty judges are missing a name (they follow).  Although none appear in panels at present, they may appear once the missing panel issue is resolved.  Also, as stated, missing data can be caused by flaws in query logic.  Ideally, the root cause of apparent data errors should be corrected.\\\\
    \footnotesize urn:entity:jud-500000312\\
